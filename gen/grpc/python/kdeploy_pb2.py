...
_ROUTE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='kdeploy.Route.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='port', full_name='kdeploy.Route.port', index=1,
...
_NETWORKING = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='routes', full_name='kdeploy.Networking.routes', index=3,
...
_ROUTE.fields_by_name['port']._options = None
