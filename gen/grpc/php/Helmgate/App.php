 ...
 *
 * Generated from protobuf message <code>helmgate.App</code>
 */
class App extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.helmgate.Release release = 5;</code>
     */
    private $release = null;
    /**
     * chart is the chart used to deploy the App
     *
     * Generated from protobuf field <code>.helmgate.Chart chart = 20;</code>
     */
    private $chart = null;
     ...
     *           namespace name the app belongs to(autocreated)
     *     @type \Helmgate\Release $release
     *           release holds information about the currently deployed release of the application
     *     @type \Helmgate\Chart $chart
     *           chart is the chart used to deploy the App
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.helmgate.Release release = 5;</code>
     * @param \Helmgate\Release $var
     * @return $this
     */
    public function setRelease($var)
    {
        GPBUtil::checkMessage($var, \Helmgate\Release::class);
        $this->release = $var;
     ...
     *
     * Generated from protobuf field <code>.helmgate.Chart chart = 20;</code>
     * @param \Helmgate\Chart $var
     * @return $this
     */
    public function setChart($var)
    {
        GPBUtil::checkMessage($var, \Helmgate\Chart::class);
        $this->chart = $var;
