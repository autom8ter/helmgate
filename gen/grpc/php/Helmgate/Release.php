 ...
 *
 * Generated from protobuf message <code>helmgate.Release</code>
 */
class Release extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.helmgate.Timestamps timestamps = 6;</code>
     */
     ...
     *     @type string $status
     *           status of the release
     *     @type \Helmgate\Timestamps $timestamps
     *           lifecycle timestamps related
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.helmgate.Timestamps timestamps = 6;</code>
     * @param \Helmgate\Timestamps $var
     * @return $this
     */
    public function setTimestamps($var)
    {
        GPBUtil::checkMessage($var, \Helmgate\Timestamps::class);
        $this->timestamps = $var;
