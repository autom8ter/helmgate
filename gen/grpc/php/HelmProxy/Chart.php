...
class Chart extends \Google\Protobuf\Internal\Message
{
     ...
     *           chart is not actively maintained if deprecated = true
     *     @type \HelmProxy\Dependency[]|\Google\Protobuf\Internal\RepeatedField $dependencies
     *           extra charts that this chart depends on
     *     @type \HelmProxy\Maintainer[]|\Google\Protobuf\Internal\RepeatedField $maintainers
     *           maintainers of this chart
     ...
     *
     * Generated from protobuf field <code>repeated .helmProxy.Dependency dependencies = 9;</code>
     * @param \HelmProxy\Dependency[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setDependencies($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \HelmProxy\Dependency::class);
     ...
     *
     * Generated from protobuf field <code>repeated .helmProxy.Maintainer maintainers = 10;</code>
     * @param \HelmProxy\Maintainer[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMaintainers($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \HelmProxy\Maintainer::class);
