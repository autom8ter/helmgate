...
class Apps extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \MeshelmProxy\App[]|\Google\Protobuf\Internal\RepeatedField $apps
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .helmProxy.App apps = 1;</code>
     * @param \MeshelmProxy\App[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setApps($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \MeshelmProxy\App::class);
        $this->apps = $arr;
