...
class Release extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $status
     *           status of the release
     *     @type \MeshelmProxy\Timestamps $timestamps
     *           lifecycle timestamps related
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.helmProxy.Timestamps timestamps = 6;</code>
     * @return \MeshelmProxy\Timestamps
     */
     ...
     *
     * Generated from protobuf field <code>.helmProxy.Timestamps timestamps = 6;</code>
     * @param \MeshelmProxy\Timestamps $var
     * @return $this
     */
    public function setTimestamps($var)
    {
        GPBUtil::checkMessage($var, \MeshelmProxy\Timestamps::class);
        $this->timestamps = $var;
