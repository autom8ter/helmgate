 ...
 *
 * Generated from protobuf message <code>helmProxy.GatewayListener</code>
 */
class GatewayListener extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.helmProxy.TransportProtocol protocol = 3 [(.validator.field) = {</code>
     */
    private $protocol = 0;
    /**
     ...
     *
     * Generated from protobuf field <code>.helmProxy.ServerTLSSettings tls_config = 5;</code>
     */
     ...
     *           hosts describes hostnames that may route to this listener
     *     @type \MeshelmProxy\ServerTLSSettings $tls_config
     *           tls_config provides tls/ssl encryption options
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \MeshelmProxy\TransportProtocol::class);
        $this->protocol = $var;
     ...
     *
     * Generated from protobuf field <code>.helmProxy.ServerTLSSettings tls_config = 5;</code>
     * @return \MeshelmProxy\ServerTLSSettings
     */
     ...
     *
     * Generated from protobuf field <code>.helmProxy.ServerTLSSettings tls_config = 5;</code>
     * @param \MeshelmProxy\ServerTLSSettings $var
     * @return $this
     */
    public function setTlsConfig($var)
    {
        GPBUtil::checkMessage($var, \MeshelmProxy\ServerTLSSettings::class);
        $this->tls_config = $var;
