 ...
 *
 * Generated from protobuf message <code>helmProxy.ServerTLSSettings</code>
 */
class ServerTLSSettings extends \Google\Protobuf\Internal\Message
{
     ...
     * tls mode
     *
     * Generated from protobuf field <code>.helmProxy.TLSmode mode = 2;</code>
     */
    private $mode = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \MeshelmProxy\TLSmode::class);
        $this->mode = $var;
