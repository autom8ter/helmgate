...
proto.meshpaas.Release.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(6, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.google.protobuf.Timestamp.serializeBinaryToWriter);
  }
};
...
/**
 * map<string, google.protobuf.Timestamp> timestamps = 6;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.google.protobuf.Timestamp>}
 */
proto.meshpaas.Release.prototype.getTimestampsMap = function(opt_noLazyCreate) {
...
proto.meshpaas.Release.prototype.clearTimestampsMap = function() {
